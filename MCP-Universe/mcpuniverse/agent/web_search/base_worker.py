"""
Base Web Search Worker.

This module provides the base class for all web search worker agents.
"""
...
from mcpuniverse.agent.web_search.state import WebSearchState
